...
public class MdSPNEGOAuthenticator extends org.keycloak.federation.kerberos.impl.SPNEGOAuthenticator{
    ...
    private static final Logger log = Logger.getLogger(MdSPNEGOAuthenticator.class);
    ...
    public MdSPNEGOAuthenticator(CommonKerberosConfig kerberosConfig, KerberosServerSubjectAuthenticator kerberosSubjectAuthenticator, String spnegoToken) {
        super(kerberosConfig, kerberosSubjectAuthenticator, spnegoToken);
